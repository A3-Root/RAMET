...
grad_meh utilizes [our Arma file formats Rust library](https://github.com/arma-tools/arma-file-formats-rs) to parse all map relevant files. So most of the magic is outsourced.  
