/*
 * Author: Root
 * Description: Calls a Python function through the FlatDevil extension,
 *              hiding the wire protocol and multipart paging from callers.
 *
 * Public: No
 *
 * Arguments:
 ...
 *   [false, kind, message]  on error (kind: "python", "dispatch", "decode",
 *                           "init", "internal")
 *
 * Usage:
